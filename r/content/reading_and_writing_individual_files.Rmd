...
This chapter contains recipes related to reading and writing individual data files using Apache 
...
dist_time <- arrow_table(
  data.frame(
    distance = c(12.2, 15.7, 14.2),
    time = c(43, 44, 40)
    )
)
...
test_that("read_feather chunk works as expected", {
  expect_identical(as.data.frame(my_feather_tbl),
   data.frame(group = c("A", "B", "C"),
    score = c(99, 97, 99)))
})
