...
You want to change the type of data in an existing Arrow Array.
...
test_that("test_incompat works as expected", {
  expect_error(int_arr$cast(target_type = binary()))
})
```
...
```{r, combine_incompat_schemas, error = TRUE}
# create first schema to combine
