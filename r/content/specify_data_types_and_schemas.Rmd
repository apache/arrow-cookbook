...
If your dataset contains files with different schemas with some overlapping 
fields which have the same names and types, they will be combined by
`open_dataset()` automatically.  The code below demonstrates how this works 
via the `unify_schemas()` function.
