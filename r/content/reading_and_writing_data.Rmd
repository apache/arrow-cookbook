...
This chapter contains recipes related to reading and writing data using Apache Arrow. 
...
* your data file is large and if you load it into memory, it may lead to performance issue
* your single data file is too large to load into memory
* your data are partitioned among numerous files and are too large to load into memory
...
You want to read a single Feather file into memory.
...
You want to save multiple data files to disk in partitions based on columns in the data.
...
You want to read multiple, partitioned data files as an Arrow Dataset.
