...
Arrow.  When reading files into R using Apache Arrow, you can read in 
a single file as a data frame or an Arrow Table, and you can read in partitioned or multi-files
as an Arrow Dataset.
