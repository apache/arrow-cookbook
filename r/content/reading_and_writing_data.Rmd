...
You can use Arrow to read JSON files.

```{r, read_json_arrow}
# Create a file to read back in 
tf <- tempfile()
writeLines('
    { "country": "United Kingdom", "code": "GB", "longitude": -3.435973, "latitude": 55.378051 }
    { "country": "France", "code": "FR", "longitude": 2.213749, "latitude": 46.227638}
    { "country": "Germany", "code": "DE", "longitude": 10.451526, "latitude": 51.165691}
  ', tf, useBytes = TRUE)

# Read in the data
countries <- read_json_arrow(tf, col_select = c("country", "longitude", "latitude"))
countries
```
...
test_that("read_json_arrow chunk works as expected", {
  expect_equivalent(
    ...
    tibble::tibble(
      ...
      longitude = c(-3.435973, 2.213749, 10.451526),
      latitude = c(55.378051, 46.227638, 51.165691)
    )
  )
})
unlink(tf)
