...
TEST_F(DatasetReadingTest, DatasetRead) {
  StartRecipeCollection([this] {
    ...
    ARROW_RETURN_NOT_OK(EndRecipe("ListPartitionedDataset"));
    ...
    ARROW_RETURN_NOT_OK(EndRecipe("CreatingADataset"));
    ...
    return EndRecipe("ScanningADataset");
  });
}
